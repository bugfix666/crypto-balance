...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Interfaces\OperationRepositoryInterface' => \App\Repositories\OperationRepository::class,
            'App\Repositories\Interfaces\PrecisionRepositoryInterface' => \App\Repositories\PrecisionRepository::class,
            'App\Repositories\Interfaces\UserRepositoryInterface' => \App\Repositories\UserRepository::class,
            'App\Repositories\Interfaces\WalletRepositoryInterface' => \App\Repositories\WalletRepository::class,
    ...
    override(\config(), map([
            ...
            'self-diagnosis.checks.Tests\Checks\RedisCanBeAccessed.default_connection' => 'boolean',
            'self-diagnosis.checks.Tests\Checks\RedisCanBeAccessed.connections' => 'array',
            'self-diagnosis.checks.BeyondCode\SelfDiagnosis\Checks\SupervisorProgramsAreRunning.programs' => 'array',
            'self-diagnosis.checks.BeyondCode\SelfDiagnosis\Checks\SupervisorProgramsAreRunning.restarted_within' => 'integer',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./www/public/storage',
'l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.use_absolute_path','l5-swagger.documentations.default.paths.docs_json',
...
'l5-swagger.defaults.paths.docs','l5-swagger.defaults.paths.views','l5-swagger.defaults.paths.base','l5-swagger.defaults.paths.swagger_ui_assets_path','l5-swagger.defaults.paths.excludes',
...
'queue.failed.table','self-diagnosis.environment_aliases.prod','self-diagnosis.environment_aliases.live','self-diagnosis.environment_aliases.local','self-diagnosis.checks',
'self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\DatabaseCanBeAccessed.default_connection','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\DatabaseCanBeAccessed.connections','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\DirectoriesHaveCorrectPermissions.directories','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\PhpExtensionsAreInstalled.extensions','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\PhpExtensionsAreInstalled.include_composer_extensions',
'self-diagnosis.checks.Tests\\Checks\\RedisCanBeAccessed.default_connection','self-diagnosis.checks.Tests\\Checks\\RedisCanBeAccessed.connections','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\SupervisorProgramsAreRunning.programs','self-diagnosis.checks.BeyondCode\\SelfDiagnosis\\Checks\\SupervisorProgramsAreRunning.restarted_within','self-diagnosis.environment_checks.development',
'self-diagnosis.environment_checks.production','self-diagnosis.environment_checks.production.BeyondCode\\SelfDiagnosis\\Checks\\PhpExtensionsAreDisabled.extensions','services.postmark.token','services.ses.key','services.ses.secret',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','horizon.stats.index',
...
'horizon.index','storage.local',);
        registerArgumentsSet('views', 
'welcome','horizon::layout','l5-swagger::index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','self-diagnosis::checks.app_key_is_set.message',
'self-diagnosis::checks.app_key_is_set.name','self-diagnosis::checks.composer_with_dev_dependencies_is_up_to_date.message','self-diagnosis::checks.composer_with_dev_dependencies_is_up_to_date.name','self-diagnosis::checks.composer_without_dev_dependencies_is_up_to_date.message','self-diagnosis::checks.composer_without_dev_dependencies_is_up_to_date.name',
'self-diagnosis::checks.configuration_is_cached.message','self-diagnosis::checks.configuration_is_cached.name','self-diagnosis::checks.configuration_is_not_cached.message','self-diagnosis::checks.configuration_is_not_cached.name','self-diagnosis::checks.correct_php_version_is_installed.message',
'self-diagnosis::checks.correct_php_version_is_installed.name','self-diagnosis::checks.database_can_be_accessed.message','self-diagnosis::checks.database_can_be_accessed.name','self-diagnosis::checks.debug_mode_is_not_enabled.message','self-diagnosis::checks.debug_mode_is_not_enabled.name',
'self-diagnosis::checks.directories_have_correct_permissions.message','self-diagnosis::checks.directories_have_correct_permissions.name','self-diagnosis::checks.env_file_exists.message','self-diagnosis::checks.env_file_exists.name','self-diagnosis::checks.example_environment_variables_are_set.message',
'self-diagnosis::checks.example_environment_variables_are_set.name','self-diagnosis::checks.example_environment_variables_are_up_to_date.message','self-diagnosis::checks.example_environment_variables_are_up_to_date.name','self-diagnosis::checks.horizon_is_running.message.not_running','self-diagnosis::checks.horizon_is_running.message.unable_to_check',
'self-diagnosis::checks.horizon_is_running.name','self-diagnosis::checks.locales_are_installed.message.cannot_run_on_windows','self-diagnosis::checks.locales_are_installed.message.locale_command_not_available','self-diagnosis::checks.locales_are_installed.message.missing_locales','self-diagnosis::checks.locales_are_installed.message.shell_exec_not_available',
'self-diagnosis::checks.locales_are_installed.name','self-diagnosis::checks.maintenance_mode_not_enabled.message','self-diagnosis::checks.maintenance_mode_not_enabled.name','self-diagnosis::checks.migrations_are_up_to_date.message.need_to_migrate','self-diagnosis::checks.migrations_are_up_to_date.message.unable_to_check',
'self-diagnosis::checks.migrations_are_up_to_date.name','self-diagnosis::checks.php_extensions_are_disabled.message','self-diagnosis::checks.php_extensions_are_disabled.name','self-diagnosis::checks.php_extensions_are_installed.message','self-diagnosis::checks.php_extensions_are_installed.name',
'self-diagnosis::checks.redis_can_be_accessed.message.not_accessible','self-diagnosis::checks.redis_can_be_accessed.message.default_cache','self-diagnosis::checks.redis_can_be_accessed.message.named_cache','self-diagnosis::checks.redis_can_be_accessed.name','self-diagnosis::checks.routes_are_cached.message',
'self-diagnosis::checks.routes_are_cached.name','self-diagnosis::checks.routes_are_not_cached.message','self-diagnosis::checks.routes_are_not_cached.name','self-diagnosis::checks.servers_are_pingable.message','self-diagnosis::checks.servers_are_pingable.name',
'self-diagnosis::checks.storage_directory_is_linked.message','self-diagnosis::checks.storage_directory_is_linked.name','self-diagnosis::checks.supervisor_programs_are_running.message.cannot_run_on_windows','self-diagnosis::checks.supervisor_programs_are_running.message.not_running_programs','self-diagnosis::checks.supervisor_programs_are_running.message.shell_exec_not_available',
'self-diagnosis::checks.supervisor_programs_are_running.message.supervisor_command_not_available','self-diagnosis::checks.supervisor_programs_are_running.name','self-diagnosis::checks.used_env_variables_are_defined.message','self-diagnosis::checks.used_env_variables_are_defined.name','self-diagnosis::commands.self_diagnosis.common_checks',
'self-diagnosis::commands.self_diagnosis.environment_specific_checks','self-diagnosis::commands.self_diagnosis.failed_checks','self-diagnosis::commands.self_diagnosis.running_check','self-diagnosis::commands.self_diagnosis.success',);
...
'DB_USERNAME','DB_PASSWORD','SESSION_DRIVER','SESSION_ENCRYPT','SESSION_PATH',
'SESSION_DOMAIN','SESSION_LIFETIME','SESSION_SECURE_COOKIE','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'QUEUE_CONNECTION','QUEUE_DRIVER','CACHE_STORE','CACHE_PREFIX','MEMCACHED_HOST',
